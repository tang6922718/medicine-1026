...
public class LiveServiceImpl implements LiveService {
    ...
    public int createLive(Map<String, Object> map) {
        ...
        map.put("room_id", TecentCloudUtils.bizid+"_"+map.get("id").toString());
        map.put("push_url",TecentCloudUtils.getPushUrl(map.get("id").toString()));
        map.put("pull_url",TecentCloudUtils.getPullUrl(map.get("id").toString()));
        map.put("pull_rtmp_url",TecentCloudUtils.getPullRtmpUrl(map.get("id").toString()));
    ...
    @Override
    public List<Map<String, Object>> selectAllLive() {
        return liveMapper.selectAllLive();
    }
