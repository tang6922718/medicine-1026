...
public class Supply {
	...
	private Character supply_cat_code; // 供应分类 供应分类（后续新增在后面加）：1 种子种苗、2 源药材、3
										// 农资农机
	private Character goods_cat_code; // 商品品种
	private Double price; // 价格
	private String price_unit; // 计价单位 1 公斤 2 斤 3 吨
	private int seller_id; // 用户ID
	private String img_url; // 商品图片
	private String specification; // 商品规格
	private int inventory; // 库存量
	private String inventory_unit; // 库存量单位 1 公斤 2 斤 3 吨
	private int sales_volumn; // 起售量
	private String sales_volumn_unit; // 起售量单位 1 公斤 2 斤 3 吨
	...
	public String getSales_volumn_unit() {
		return sales_volumn_unit;
	}
	public void setSales_volumn_unit(String sales_volumn_unit) {
